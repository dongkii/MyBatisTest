...
public class BoardDao {
	...
	public BoardDao(){
		prop = new Properties();
		String currentPath = BoardDao.class.getResource("./").getPath();
		try {
			prop.load(new FileReader(currentPath + "board.properties"));
		} catch (IOException e) {			
			e.printStackTrace();
		}
	}
	...
	public int addReadCount(Connection con, int bnum) {
		...
		/*String query = "update board set "
				...
				+ "where board_num = ?";*/
		String query = prop.getProperty("addReadCount");
	...
	public int updateReplySeq(Connection con, Board replyBoard) {
		...
		/*String query = "update board set "
				...
				+ "and board_reply_ref = ?";*/
		String query = prop.getProperty("updateReplySeq");
